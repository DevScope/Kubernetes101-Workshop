...
Now that you are able to run a multi-project application with [`tye run`](https://github.com/dotnet/tye/blob/main/docs/reference/commandline/tye-run.md), move on to [the next step (deploy)](01_deploy.md) to learn how to deploy this application to Kubernetes.
